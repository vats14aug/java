...
public class Sample {
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        try {
            ...
            statement.executeUpdate("CREATE TABLE person (score INTEGER)");
            ...
            */
            ...
            statement.executeUpdate("INSERT INTO person values(' " + getScore() + "')");
            ...
            while (resultSet.next()) {
              ...
              */
                System.out.println("name = " + resultSet.getInt("score"));
            }
